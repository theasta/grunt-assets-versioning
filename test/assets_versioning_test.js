...
exports.assets_versioning = {
  ...
  bundles_with_date: function(test) {
    ...
    var configLog = grunt.config.get('assets_versioning.log.bundles_with_date');

    var expectedConfigLog = { files:
      [ { src:
  ...
  images_with_date: function(test) {
    ...
    var configLog = grunt.config.get('assets_versioning.log.images_with_date');
  ...
  images_with_start_date: function(test) {
    ...
    var configLog = grunt.config.get('assets_versioning.log.images_with_start_date');
  ...
  images_with_hash: function(test) {
    ...
    var configLog = grunt.config.get('assets_versioning.log.images_with_hash');
