...
Type: `String`
Path to the file in which you want to dump the map of versions generated.

The assets versioning files outputs a map of versions of all the files processed. Here's how that map looks like:
`
[
  { version: '3d04f375', originalPath: 'path/to/bundle-a.js', versionedPath: 'path/to/bundle_a.js'},
  { version: '3d04f375', originalPath: 'path/to/bundle-b.js', versionedPath: 'path/to/bundle-b.js'}
]
`
...
`
[
  { version: '3d04f375', originalPath: 'super/long/path/to/bundle-a.js', versionedPath: 'super/long/path/to/bundle_a.js'},
  { version: '3d04f375', originalPath: 'super/long/path/to/bundle-b.js', versionedPath: 'super/long/path/to/bundle-b.js'}
]
`
...
`
[
  { version: '3d04f375', originalPath: 'bundle-a.js', versionedPath: 'bundle_a.js'},
  { version: '3d04f375', originalPath: 'bundle-b.js', versionedPath: 'bundle-b.js'}
]
`
